...
//------------------------------------------------------------------------------------------------
//Level 2
//Read about switch statements here: https://developer.apple.com/library/ios/documentation/Swift/Conceptual/Swift_Programming_Language/ControlFlow.html#//apple_ref/doc/uid/TP40014097-CH9-ID127 (scroll down below the if statements)
//change your logic control in your function to use a switch statement instead of if/else if/else
